...
## Single-cell IsoSeq
echo isoseq3 collapse ${outdir}/${prefix}.aligned.bam ${outdir}/${prefix}.collapse.gff
[ ! -f "${outdir}/${prefix}.collapse.gff" ] && isoseq3 collapse ${outdir}/${prefix}.aligned.bam ${outdir}/${prefix}.collapse.gff
## Bulk IsoSeq
...
echo pigeon make-seurat --dedup ${outdir}/${prefix}.dedup.fasta --group ${outdir}/${prefix}.collapse.group.txt -d ${outdir} -o ${prefix} ${outdir}/${prefix}_classification.filtered_lite_classification.txt
pigeon make-seurat --dedup ${outdir}/${prefix}.dedup.fasta --group ${outdir}/${prefix}.collapse.group.txt -d ${outdir} -o ${prefix} ${outdir}/${prefix}_classification.filtered_lite_classification.txt
